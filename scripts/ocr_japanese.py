Add scripts for image cutout and OCR

This commit introduces two new Python scripts:
- `cutout.py`: A script for cropping images based on percentage-based
  configuration.
- `ocr_japanese_local.py`: A script for performing local OCR on Japanese
  text within images using the `manga-ocr` library.
